package com.svs.myprojects.bollywoodquiz.online;
...
public class VideoRound extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_round_activity);
    ...
    /***********************************************************************************************
     * You tube player initialization
     */
    ...
    private void setNextQuestion() {
        ...
        if (mCurrentQuestionIndex < mQuestionModelHashMap.size()) {
            ...
            mYouTubePlayer.loadVideo(mCurrentQuestionModel.question);
...
//        if (mLevel.equals(com.svs.myprojects.bollywoodquiz.Constants.OFFLINE_LEVEL_INTER)) {
        inputStream = getResources().openRawResource(R.raw.qa_video_round);
//        } else {
