 ...
 * true, true));
 */
public class DividerItemDecorationSeparator extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecorationSeparator(Context context, AttributeSet attrs) {
    ...
    public DividerItemDecorationSeparator(Context context, AttributeSet attrs, boolean showFirstDivider,
    ...
    public DividerItemDecorationSeparator(Context context, int resId) {
        mDivider = ContextCompat.getDrawable(context, resId);
    }

    public DividerItemDecorationSeparator(Context context, int resId, boolean showFirstDivider,
                                          boolean showLastDivider) {
        this(context, resId);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
    ...
    public DividerItemDecorationSeparator(Drawable divider) {
        mDivider = divider;
    }

    public DividerItemDecorationSeparator(Drawable divider, boolean showFirstDivider,
                                          boolean showLastDivider) {
        this(divider);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
